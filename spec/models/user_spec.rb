...
describe User do
  ...
  before do 
  	@user = User.new(name: "Ngoc nguyen", email: "ngocnt_54@vnu.edu.vn", password: "123456", password_confirmation: "123456")
  end
  subject { @user }
  ...
  describe "when email format is invalid" do
  	it  "should be invalid"  do
   	...
   	describe "when email address is already takeen" do
   	before do
  ...
  describe "when password doesn't match confirmation" do
    before { @user.password_confirmation = "ngoc" }
    it { should_not be_valid }
  end
